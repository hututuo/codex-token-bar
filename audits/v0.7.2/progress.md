...
| 12. Review-gated repairs | in_progress | Tauri `89809d3`, `61f9871`; Swift `68e8fd2`, `e7b96fd`, `fe4f00c`; `.superpowers/sdd/task-{1,2,4,5}-review.md` | Target validation and Swift running-app/lease protection are approved. Tauri timeout ownership has 3 Important/2 Minor findings under correction. Swift restore transaction has 1 Critical/5 Important findings under correction; neither task advances until re-review is clean. |
