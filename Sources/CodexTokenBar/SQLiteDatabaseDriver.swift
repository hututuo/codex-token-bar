...
/// selected by SQLite after the main path has been opened. This normalizer is
/// intentionally limited to the peer quota boundary; ordinary SQLite callers
/// must continue to receive exactly the URL they supplied.
enum SQLitePeerDatabasePath {
...
final class SQLitePeerDatabaseReader: DatabaseAccessing, @unchecked Sendable {
    ...
    init(
        ...
        self.url = SQLitePeerDatabasePath.mainURL(for: url)
