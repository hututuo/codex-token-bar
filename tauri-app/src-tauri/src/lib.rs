...
pub fn run() {
    ...
    let app_result = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::settings::save_quota_history_filter,
            ...
            commands::floating_guide::prepare_floating_guide_overlay,
            commands::floating_guide::floating_guide_overlay_ready,
            commands::floating_guide::floating_guide_overlay_event,
            commands::floating_guide::update_floating_guide_overlay,
